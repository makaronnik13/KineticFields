...
public class FFTSerivce: ITickable
{
    ...
    public FFTSerivce()
    {
        ...
        _wasapiAudio = new WasapiAudio(CaptureType, SpectrumSize, ScalingStrategy, MinFrequency, MaxFrequency, Filters, spectrumData =>
        {
    ...
    public void SetSourceType(MMDevice microphone)
    {
        ...
        _wasapiAudio = new WasapiAudio(wct, SpectrumSize, ScalingStrategy, MinFrequency, MaxFrequency, Filters, spectrumData =>
        {
            _spectrumData = spectrumData;
        });
